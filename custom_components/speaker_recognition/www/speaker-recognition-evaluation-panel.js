...
const BasePanel = customElements.get("speaker-recognition-settings-panel");

class SpeakerRecognitionEvaluationPanel extends BasePanel {
  constructor() {
    super();
  ...
  async _refreshComparison(silent = false) {
...
customElements.define("speaker-recognition-evaluation-panel", SpeakerRecognitionEvaluationPanel);
